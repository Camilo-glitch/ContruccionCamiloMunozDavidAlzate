...
public class principal {
	...
	public static void main(String[] args) {
		...
		Club ClubCD = contexto.getBean("ClubCD", Club.class);
			...
			try {
				...
				switch(opcion) {
					...
					case 1: {
						...
						personasBussiness.descartarCedulaEnSocios(ClubCD.getSocios(), cedula);
						personasBussiness.descartarCedulaEnAutorizados(ClubCD.getSocios(), cedula);
						...
						socioBussiness.validarCupoParaSocio(tipoDeSuscripcion, ClubCD.getSocios());
					...
					case 2: {
						...
						int cedula = personasInput.validarCedula(input.next());
						socioBussiness.eliminarSocio(ClubCD.getSocios(), cedula);
					...
					case 3: {
						...
						Socio socio = personasBussiness.buscarSocio(ClubCD.getSocios(), personasInput.validarCedula(input.next()));
					...
					case 4: {
						...
						int cedula = personasInput.validarCedula(input.next());
						autorizadoBussiness.eliminarAutorizado(ClubCD.getSocios(), cedula);
					...
					case 7: {
						...
						Autorizado autorizado = personasBussiness.buscarAutorizado(ClubCD.getSocios(), personasInput.validarCedula(input.next()));
						...
						System.out.println("Ingrese el valor de lo que consumio: ");
						double valor = facturasInput.validarValor(input.next());
						Socio socio = autorizadoBussiness.buscarSocioDeAutorizado(ClubCD.getSocios(), autorizado.getCedula());
						clubBussiness.validarFondosSuficientes(valor, socio.getFondos());
						...
						while(ejecucion2) {
							...
							switch(opcion2) {
								...
								case 7: {
									...
									System.out.println("______________________________");
									System.out.println(ClubCD.mostrarSocios());
									System.out.println("______________________________");
									break;
								}
								case 8: {
									...
									System.out.println("______________________________");
									System.out.println(ClubCD.mostrarSociosConAutorizados());
									System.out.println("______________________________");
									break;
								}
								case 9: {
									...
									System.out.println("______________________________");
									System.out.println(ClubCD.mostrarTodo());
									System.out.println("______________________________");
									break;
								}
								default: {
